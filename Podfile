...
def gutenberg(options)
    options[:git] = 'https://github.com/cameronvoell/gutenberg-mobile.git'
...
def gutenberg_dependencies(options)
    ...
    if options[:path]
        ...
        podspec_prefix = "https://raw.githubusercontent.com/cameronvoell/gutenberg-mobile/#{tag_or_commit}"
    end
...
abstract_target 'Apps' do
    ...
    ## =====================
    ##
    gutenberg :commit => '30c226854489c4aa390deb10ac593b26b3dc5b3a'
